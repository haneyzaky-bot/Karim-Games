...
function ownerFromPointer(e) {
  ...
  // ✅ إصلاح الموبايل: اختيار اللاعب من شريط تحكم بدل تقسيم الشاشة نصفين
  if (window.stateInput && window.stateInput.activeOwner) {
    return window.stateInput.activeOwner;
  }
